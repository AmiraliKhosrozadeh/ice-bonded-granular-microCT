...
# CT channel origin in um — from info.txt (scan{N}_dragonfly/info.txt).
...
# Crop offset in cropped voxels — 0 because CT_ORIGIN_UM is already relative
...
# Thresholds (T5_HR scan 1) — from scan01_histogram_analysis.py (info.txt).
...
for z in range(nz):
    ...
    # 'ice+glass' gray range is full — this catches the compression punch
