...
# markers. More robust than peak_local_max for touching particles, which can
# collapse two nearby peaks into one.
...
CT_CHANNEL_NAME   = 'Glass-1001800-T5-normal_100XXL_uc_xy_0098'  # scan 1 raw channel (not pyramid)
...
OUT_DIR = r'E:\RPTU-images\CT_images\Glass\Glass_spam\scan01\results'
os.makedirs(OUT_DIR, exist_ok=True)
CSV_PATH = os.path.join(OUT_DIR, 'bead_measurements.csv')

# SPAM export target for bead labels (scan 1)
...
ERODE_ITERATIONS = 24   # voxels to erode. Higher = more aggressive splitting of touching beads.
