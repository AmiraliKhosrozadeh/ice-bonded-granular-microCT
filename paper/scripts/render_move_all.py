"""ORIGIN of figures/dic_G1_1to3_motion.png and dic_G1_1to3_radial.png.

This is the bead-motion renderer from the DIC session, kept here for the
record.  It runs under WSL in ~/spam-venv from the directory that holds its
helper modules (_plotrules, _legend_guard, _strain_measure, _spec,
_bead_filter) and the cumulative_<specimen>.npz files, which is

    /mnt/c/Users/cak7496/AppData/Local/Temp/claude/D--wsl/
        a62987fb-a2df-41c2-a6a3-fd119ddec5c2/scratchpad

    GHOST_OPACITY=0.28 python _render_move_all.py Glass_75_1700_T5_HR disp radial

The 1->3 panels come from cumulative_Glass_75_1700_T5_HR.npz, 264 beads
followed from scan 1 through scan 3.  GHOST_OPACITY is the one change made
for the paper: at the original 0.11 the initial scan was invisible.
