...
CT_CHANNEL_NAME   = 'Glass-1001800-T5-normal_scan2_4_100XXL_uc_xy_0088'  # scan 2 raw channel (not pyramid)
...
PSD_MAX_FERET_RATIO = 1.5

OUT_DIR = r'E:\RPTU-images\CT_images\Glass\Glass_scan02_dragonfly\results'
...
SPAM_LABELS_PATH = os.path.join(SPAM_DATA_DIR, 'bead_labels_scan02.tif')
...
psd_keep = ratio <= PSD_MAX_FERET_RATIO
